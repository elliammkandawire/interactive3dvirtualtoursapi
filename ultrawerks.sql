...
) ENGINE=InnoDB DEFAULT  COLLATE=DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `register` (
  ...
  `email` varchar(100) CHARACTER SET utf8mb4 COLLATE DEFAULT CHARSET=latin1 NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT  COLLATE=DEFAULT CHARSET=latin1;
